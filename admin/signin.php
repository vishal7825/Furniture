...
<head>
  ...
  <title>RR Furniture Shop Management System | Admin - Dashboard</title>
        ...
        <div class="container mt-5">
          <div class="row">
            <div class="col-md-9 col-lg-8 mx-auto">
              ...
              <h3 class="login-heading text-center mb-4">RR Furniture Shop Management System</h3>
              <form method="post">
              <?php
              if(isset($error)){
                ...
                <div class="form-group">
                 ...
                 <input type="email" name="email" class="form-control" placeholder="Email address" pattern="^[A-Za-z\._\-0-9]*[@][A-Za-z]*[\.][a-z]{2,4}" required autofocus>
                </div>
